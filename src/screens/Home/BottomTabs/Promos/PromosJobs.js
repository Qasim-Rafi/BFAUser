  ...
  return (
    <View style={{ marginTop: 30 }}>
      ...
      {PROMOSJOBS.map((item, index) => {
        return (
          <TouchableOpacity
            onPress={() => props.navigation.navigate(routeName.APPLY_JOBS)}>
            <View
              style={{
              ...
              <View style={{ marginTop: '2%', marginLeft: '2%' }}>
                <Icon source={item.Logo} borderRadius={5} size={65} />
              </View>
              <View style={{ marginTop: '2%', marginLeft: '2%' }}>
                <View>
                ...
                <View style={{ flexDirection: 'row' }}>
                  <ResponsiveText size={2.8} color={colors.yellow}>
                    {item.ResturantName}-
                  </ResponsiveText>
                ...
                <View
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <ResponsiveText size={2.8} color={colors.white}>
                      {item.Date}
                    </ResponsiveText>
                  </View>
                  <View style={{ flexDirection: 'row' }}>
