...
import { myPromosListingTabs, yourFavoriteFakeDATA } from '../../../../constants/mock'
    ...
    return (
        <View style={{ backgroundColor: colors.black3, flex: 1 }}>
            ...
            <ScrollView>
                ...
                <View style={{ marginHorizontal: 20, marginTop: 10, backgroundColor: colors.black3 }}>
