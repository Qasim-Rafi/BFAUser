                        ...
                        {Reviews.map((item) => {
                            return (
                                ...
                                <View style={{ flexDirection: 'row', marginRight: 20, marginLeft: 40, backgroundColor: colors.black2, padding: 10, borderRadius: 7, marginBottom: 10 }}>
                                    ...
                                    <Icon borderColor={colors.grey} borderWidth={10} margin={[1, 0, 0, -33]} source={{ uri: item.fullPath }} borderRadius={40} size={50} />
                                    ...
                                    <View style={{ justifyContent: 'center', paddingRight: 5 }}>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: wp(70), marginLeft: 15 }}>
                                            <ResponsiveText color={colors.white} size={3.5} >{item.restaurantBranchName}</ResponsiveText>
                                            <ResponsiveText color={colors.grey} size={2.5} >{moment(new Date()).format(" MMMM Do YYYY")}</ResponsiveText>
                                        </View>
                                        ...
                                        <View style={{ marginRight: 10, marginLeft: 15, overflow: 'hidden', }}>
                                            <ResponsiveText color={colors.grey} size={3} margin={[5, 10, 0, 0]} >{item.reviews}</ResponsiveText>
                                        </View>
                                    </View>
                                </View>
                            )
