        ...
        <View style={{backgroundColor:'#202020',flex:1}}>
            ...
            <View style={{flex:0.9}}>
                <View style={{flexDirection:'row',justifyContent:'space-between',margin:10,}}>
                    <View style={{backgroundColor:'#303030',height:hp(28 ), width:wp(45), justifyContent:'space-around',alignItems:'center'}}>
                ...
                <View style={{margin:10}}>
                    <View style={{backgroundColor:'#303030',height:hp(9 ),flexDirection:'row',justifyContent:'center',alignItems:'center' }}>
                    ...
                    <View style={{backgroundColor:'#303030',height:hp(9 ),marginTop:20,flexDirection:'row',justifyContent:'center',alignItems:'center' }}>
