...
import { Image, Text, Animated, ScrollView, StyleSheet, View, ImageBackground, TouchableOpacity } from 'react-native'
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        <View style={{ width: 90, height: 130, marginRight: 5, borderRadius: 3, overflow: 'hidden', flexDirection: 'row' }}>
                                            <ImageBackground style={{ flex: 1, padding: 5, overflow: 'hidden', justifyContent: 'flex-end' }} source={{ uri: url.imageDataB }}>
