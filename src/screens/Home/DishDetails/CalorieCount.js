    ...
    return (
        ...
        <View style={{ backgroundColor: '#404040', }}>
            <View style={{ margin: 20 }}>
                ...
                <View style={{ backgroundColor: '#40CEFB', height: 5, width: "100%", borderRadius: 20, paddingBottom: 3 ,margin:5}}></View>
            </View>
            <View style={{ height: hp(30), flexDirection: 'row' }}>
                ...
                <View style={{ flex: 1, display: 'flex',flexWrap: 'wrap' }}>
                    {FakeCaloriesData.map((item,index) => {
                        return (
                            <View style={{ backgroundColor: item.colors, height: 100, width: 80, borderRadius: 20, paddingBottom: 3 ,margin:5}}>
                                ...
                                <View style={{ flex: 0.4, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', borderBottomEndRadius: 20, borderBottomStartRadius: 20, marginHorizontal: 3 }}>
