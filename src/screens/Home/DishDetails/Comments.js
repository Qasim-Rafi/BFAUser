...
import { Image, ScrollView, StyleSheet, View, ImageBackground, TextInput } from 'react-native'
...
const image = { uri: "https://images.unsplash.com/photo-1440847899694-90043f91c7f9?h=1024" };
    return (
        ...
        <View style={{margin:20}}>
                ...
                <View style={{borderBottomWidth:1,borderBottomColor:colors.grey,top:15}}>
