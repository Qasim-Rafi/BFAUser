...
import {TouchableOpacity, Image, ScrollView, StyleSheet, View, ImageBackground ,Text} from 'react-native'
    ...
    return (
        <>
            <View style={styles.everyOneFavoriteHeaderSection}>
                <ResponsiveText size={4} color={colors.white}>Resturant</ResponsiveText>
